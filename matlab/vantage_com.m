function [com3d, com2bb, com2bbMean, C] = vantage_com(varargin)
...
%       - com3d = vantage_com 
%       - [com3d, com2bb, com2bbMean, C] = vantage_com 
...
% Set bottom bracket XY coordinates
bb = c(1:2);

% Set estimated crank length in mm
crankLength = c(3);
